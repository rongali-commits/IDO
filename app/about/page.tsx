  ...
  return (
    <main className="about-page">
      ...
      <section className="about-copy shell-narrow">
        ...
        <p>Outside Noerong, I also build practical software—Python automations, AI assistants, and focused web tools. You can see that work, along with my projects and professional profile, at <a className="personal-site-link" href="https://www.rongalichaitanya.com/" target="_blank" rel="noreferrer">RongaliChaitanya.com ↗</a>.</p>
