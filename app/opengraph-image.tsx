...
export const alt = "Noerong — Big questions, carefully explored";
  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "72px 82px", color: "#17231f", background: "#f6f0e5", fontFamily: "Georgia, serif" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column" }}>
        <div style={{ display: "flex", maxWidth: 950, fontSize: 86, lineHeight: 0.98, letterSpacing: -4 }}>Big questions.<br />Carefully explored.</div>
        <div style={{ display: "flex", marginTop: 32, fontFamily: "Arial, sans-serif", fontSize: 25, color: "#58615c" }}>Independent essays on history, science, philosophy, and civilization.</div>
      </div>
