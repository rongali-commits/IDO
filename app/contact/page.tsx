    ...
    <main>
      ...
      <section className="contact-page shell">
        <div className="contact-grid">
          ...
          <div><div className="contact-links"><a href="mailto:hello@noerong.com?subject=Noerong%20project%20enquiry">Email Noerong <span>↗</span></a><a href="https://contra.com/noerong_au1wq0v2" target="_blank" rel="noreferrer">Start through Contra <span>↗</span></a><a href="https://www.upwork.com/freelancers/~017d6b93e78fe54961" target="_blank" rel="noreferrer">Start through Upwork <span>↗</span></a><a href="https://www.linkedin.com/in/rongalichaitanya" target="_blank" rel="noreferrer">Connect on LinkedIn <span>↗</span></a></div><div className="response-note"><strong>Based in Bengaluru. Working worldwide.</strong><span>Send a short brief and I will respond with the clearest next step.</span></div></div>
        </div>
      </section>
      <SiteFooter />
    </main>
