...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Start a project | Noerong", description: "Share one workflow, your current tools, and the outcome you need. Start with a clear, scoped next step.", url: "https://noerong.com/contact", images: [{ url: "/og-design-2026.webp", alt: "Start a project with Noerong" }] },
  twitter: { card: "summary_large_image", title: "Start a project | Noerong", description: "A clear first step for your SaaS product or business workflow.", images: ["/og-design-2026.webp"] },
};
    ...
    <main>
      ...
      <section className="contact-page shell">
        <div className="contact-grid">
          <div><p className="section-kicker">Start a project</p><h1>Tell me what<br /><em>you imagine.</em></h1><p className="contact-lead">Tell me about the website or product you have in mind, who it is for, and what a successful outcome would look like. I will reply with a clear next step.</p></div>
